 ...
 * @property {string} [Output='object'] - Desired output type. Will be set for any further `get` calls except if reassigned or overwritten via `get` [`output_format`]{@link module:collmex-client.get.output_format} parameter.
 */
